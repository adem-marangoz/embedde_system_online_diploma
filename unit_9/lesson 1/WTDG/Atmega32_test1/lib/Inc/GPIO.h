...
typedef struct
{
    unsigned char pin;          /* Specifies the GPIO pin select pin to be configured
                                The parameter can be any value of @ref GPIO_Pin_define */
    En_Pin_config mode;         /* Specifies the GPIO mode select to be configured
                                The parameter can be any value of @ref GPIO_Mode_define */
    En_PUD PUPD;                /* Specifies the GPIO PUll Up/Down to be configured
                                The parameter can be any value of @ref GPIO_Pull_define */
}GPIO_config;
