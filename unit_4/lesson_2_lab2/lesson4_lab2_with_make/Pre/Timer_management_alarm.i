...
{
 {fflush(
# 17 "Src/Timer_management_alarm.c" 3
(&_iob[0])
# 17 "Src/Timer_management_alarm.c"
); fflush(
# 17 "Src/Timer_management_alarm.c" 3
(&_iob[1])
# 17 "Src/Timer_management_alarm.c"
); printf("\nTimer_management_alarm:---> Timer is Off ---"); fflush(
# 17 "Src/Timer_management_alarm.c" 3
(&_iob[0])
# 17 "Src/Timer_management_alarm.c"
); fflush(
...
void Timer_Timer_Alarm_On()
{
 ...
 if(counter1>=2)
  {fflush(
# 26 "Src/Timer_management_alarm.c" 3
 (&_iob[0])
# 26 "Src/Timer_management_alarm.c"
 ); fflush(
# 26 "Src/Timer_management_alarm.c" 3
 (&_iob[1])
# 26 "Src/Timer_management_alarm.c"
 ); printf("Timer_management_alarm:---> Timer counting --->\n"); fflush(
# 26 "Src/Timer_management_alarm.c" 3
 (&_iob[0])
# 26 "Src/Timer_management_alarm.c"
 ); fflush(
...
# 26 "Src/Timer_management_alarm.c"
 ...
 if(counter1==8)
 {
  ...
  Timer_p_fun();
  {fflush(
# 32 "Src/Timer_management_alarm.c" 3
 (&_iob[0])
# 32 "Src/Timer_management_alarm.c"
 ); fflush(
# 32 "Src/Timer_management_alarm.c" 3
 (&_iob[1])
# 32 "Src/Timer_management_alarm.c"
 ); printf("\nTimer_management_alarm:---> Ending 60s for Timer "); fflush(
# 32 "Src/Timer_management_alarm.c" 3
 (&_iob[0])
# 32 "Src/Timer_management_alarm.c"
 ); fflush(
...
{
 {fflush(
# 39 "Src/Timer_management_alarm.c" 3
(&_iob[0])
# 39 "Src/Timer_management_alarm.c"
); fflush(
# 39 "Src/Timer_management_alarm.c" 3
(&_iob[1])
# 39 "Src/Timer_management_alarm.c"
); printf("Timer_management_alarm:---> Timer is On ---->\n"); fflush(
# 39 "Src/Timer_management_alarm.c" 3
(&_iob[0])
# 39 "Src/Timer_management_alarm.c"
); fflush(
