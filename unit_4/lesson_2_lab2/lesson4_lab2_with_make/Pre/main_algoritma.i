...
{
 {fflush(
# 25 "Src/main_algoritma.c" 3
(&_iob[0])
# 25 "Src/main_algoritma.c"
); fflush(
# 25 "Src/main_algoritma.c" 3
(&_iob[1])
# 25 "Src/main_algoritma.c"
...
# 25 "Src/main_algoritma.c"
 ...
 {
  {fflush(
# 28 "Src/main_algoritma.c" 3
 (&_iob[0])
# 28 "Src/main_algoritma.c"
 ); fflush(
# 28 "Src/main_algoritma.c" 3
 (&_iob[1])
# 28 "Src/main_algoritma.c"
 ); printf("main_algoritma:---> Pressure High Detected\n"); fflush(
# 28 "Src/main_algoritma.c" 3
 (&_iob[0])
# 28 "Src/main_algoritma.c"
 ); fflush(
...
void Send_pressure_value(unsigned int p)
{
 Pressure_Value=p;
 {fflush(
# 38 "Src/main_algoritma.c" 3
(&_iob[0])
# 38 "Src/main_algoritma.c"
); fflush(
# 38 "Src/main_algoritma.c" 3
(&_iob[1])
# 38 "Src/main_algoritma.c"
); printf("\nmain_algoritma:---> Data Received "); fflush(
# 38 "Src/main_algoritma.c" 3
(&_iob[0])
# 38 "Src/main_algoritma.c"
); fflush(
