...
{
 {fflush(
# 24 "Src/Pressure_sensor_driver.c" 3
(&_iob[0])
# 24 "Src/Pressure_sensor_driver.c"
); fflush(
# 24 "Src/Pressure_sensor_driver.c" 3
(&_iob[1])
# 24 "Src/Pressure_sensor_driver.c"
...
void Pr_Reading_and_sending()
{
 ...
 {fflush(
# 30 "Src/Pressure_sensor_driver.c" 3
(&_iob[0])
# 30 "Src/Pressure_sensor_driver.c"
); fflush(
# 30 "Src/Pressure_sensor_driver.c" 3
(&_iob[1])
# 30 "Src/Pressure_sensor_driver.c"
); printf("\nPressure_sensor_driver:---> Reading Pressure value = %d ",Pressure_Value); fflush(
# 30 "Src/Pressure_sensor_driver.c" 3
(&_iob[0])
# 30 "Src/Pressure_sensor_driver.c"
); fflush(
...
{
 {fflush(
# 39 "Src/Pressure_sensor_driver.c" 3
(&_iob[0])
# 39 "Src/Pressure_sensor_driver.c"
); fflush(
# 39 "Src/Pressure_sensor_driver.c" 3
(&_iob[1])
# 39 "Src/Pressure_sensor_driver.c"
...
# 39 "Src/Pressure_sensor_driver.c"
 ...
 if(counter==5)
 {
  ...
  {fflush(
# 46 "Src/Pressure_sensor_driver.c" 3
 (&_iob[0])
# 46 "Src/Pressure_sensor_driver.c"
 ); fflush(
# 46 "Src/Pressure_sensor_driver.c" 3
 (&_iob[1])
# 46 "Src/Pressure_sensor_driver.c"
 ); printf("Pressure_sensor_driver:---> Ending wait for pressure\n"); fflush(
# 46 "Src/Pressure_sensor_driver.c" 3
 (&_iob[0])
# 46 "Src/Pressure_sensor_driver.c"
 ); fflush(
