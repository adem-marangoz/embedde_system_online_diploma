...
/**
 * @brief is used to display string on lcd and stop with specified character
 * @param lcd_instance lcd data structre
 * @param ch string data
 * @param Stop_char specifie character
 * @return uint8_t 
 */
