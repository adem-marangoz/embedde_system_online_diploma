...
void config(void)
{
    ...
    //_________________________ Config LCD_Driver _______________________________
    ...
    spi1_config.BaudRate = FPCLK_div_8;
        ...
        spi1_config.Rx_Tx_interrupt = SPI_interrupt_Dis;
         ...
         // _________________ Config NSS PIN As a Normal Pin ___________________
        ...
        spi1_config.Slave_Select_Software = Software_Mang_Disable;
        spi1_config.Rx_Tx_interrupt = Rx_Interrupt_En;
    #endif
